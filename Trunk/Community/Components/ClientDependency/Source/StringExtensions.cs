...
namespace ClientDependency.Core
{
    public static class StringExtensions
    {
        ...
        /// </summary>
        [Obsolete("method is no longer used as Md5 is not a FIPS compliant algorithm")]
        ...
        public static string GenerateSha256Hash(this string str)
        {
            ...
            {
                byte[] byteArray = hasher.ComputeHash(Encoding.Unicode.GetBytes(str));
