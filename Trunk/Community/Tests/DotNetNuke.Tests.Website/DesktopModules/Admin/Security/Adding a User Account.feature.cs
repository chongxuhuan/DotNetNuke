...
#line 27
 testRunner.Then(string.Format("The newly added user account can now be viewed and modified using the User Accoun" +
                        "ts module {0}", userName), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line 28
