        ...
        <dnn:DnnGrid ID="ProfilesList" AutoGenerateColumns="false" runat="server" AllowSorting="true">             
              <MasterTableView  EditMode="InPlace">
                    <Columns>
                            ...
                            <dnn:DnnGridTemplateColumn HeaderText="" HeaderStyle-Width="30px">
					            <ItemTemplate>
                              <%--       <dnn:DnnImageButton runat="server" ID="lnkDelete" resourcekey="saveRule" CommandName="Delete"
							            CommandArgument='<%#Eval("Id") %>' IconKey="Delete" CssClass="delete"  />--%>
                            ...
                            <dnn:DnnGridTemplateColumn HeaderText="Device Name" HeaderStyle-Width="120px" >
					            <ItemTemplate>
						            <%#Eval("Name") %>
					            </ItemTemplate>
					            <EditItemTemplate>						         
				            ...
				            <dnn:DnnGridTemplateColumn HeaderText="Width">
					            <ItemTemplate>
						            <%#Eval("Width") %>
					            </ItemTemplate>
					            <EditItemTemplate>
						        
							        <asp:TextBox ID="txtEditWidth" runat="server" MaxLength="4" 
								        Text='<%#Eval("Width") %>' />
				            ...
				            <dnn:DnnGridTemplateColumn HeaderText="Height">
					            <ItemTemplate>
						            <%#Eval("Height") %>
					            </ItemTemplate>
					            <EditItemTemplate>
						           
							        <asp:TextBox ID="txtEditHeight" runat="server" MaxLength="4"  CssClass="dnnFormRequired"
								        Text='<%#Eval("Height") %>' />
				            ...
				            <dnn:DnnGridTemplateColumn HeaderText="USER AGENT">
					            <ItemTemplate>
