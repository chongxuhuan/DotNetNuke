...
<table id="tblSendPassword" runat="server" cellspacing="0" cellpadding="3" border="0" summary="SignIn Design Table" >
	...
	<tr>
		<td>
            ...
            <asp:HyperLink ID="loginLink" runat="server" cssclass="CommandButton" visible="false">
                <asp:Image ID="loginLinkImage" runat="server" imageurl="~/images/rt.gif" />
                <asp:Label ID="loginLinkLabel" runat="server" resourcekey="cmdLogin" />
            </asp:HyperLink>
		</td>
	</tr>
</table>
