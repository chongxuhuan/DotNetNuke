...
<br/>
<asp:DropDownList id="cboSkin" runat="server" cssclass="NormalTextBox SkinList"></asp:DropDownList>&nbsp;<dnn:CommandButton ID="cmdPreview" Runat="server" CssClass="CommandButton" EnableViewState="False" resourcekey="Preview" ImageUrl="~/images/view.gif" />
