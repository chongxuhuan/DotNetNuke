...
<div class="dnnForm dnnLanguages dnnClear" id="dnnLanguages">
    <fieldset>
        ...
        <div class="dnnFormItem">
            ...
            <dnn:DnnLanguageComboBox ID="languageComboBox" runat="server" LanguagesListType="All" Width="250px" ShowModeButtons="false" />
        </div>
        <div class="dnnFormItem">
            ...
            <dnn:DnnLanguageComboBox ID="fallBackComboBox" runat="server" LanguagesListType="Supported" Width="250px" />
        </div>
