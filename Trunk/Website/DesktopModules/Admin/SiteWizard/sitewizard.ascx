...
<asp:Wizard ID="Wizard" runat="server" DisplaySideBar="false" ActiveStepIndex="0"
    ...
    <HeaderTemplate>
        <asp:Label ID="lblTitle" CssClass="Head" runat="server"><% =DotNetNuke.Services.Localization.Localization.GetString(Wizard.ActiveStep.Title + ".Title", this.LocalResourceFile)%></asp:Label><br /><br />
        <asp:Label ID="lblHelp" CssClass="WizardText" runat="server"><% =DotNetNuke.Services.Localization.Localization.GetString(Wizard.ActiveStep.Title + ".Help", this.LocalResourceFile)%></asp:Label>
    </HeaderTemplate>
    <WizardSteps>
