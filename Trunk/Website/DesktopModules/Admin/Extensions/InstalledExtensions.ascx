...
<asp:Label ID="lblUpdate" runat="server" CssClass="" resourceKey="lblUpdate" />
<div class="dnnFormItem" id="languageSelectorRow" runat="server">
    ...
    <asp:DropDownList ID="cboLocales" runat="server" DataTextField="Text" DataValueField="Code" AutoPostBack="true" CssClass="dnnFormInput" />
</div>
