        ...
        <div class="dnnFormItem">
			...
			<asp:panel id="pnlReset" runat="server">
                ...
                <div id="answerRow" runat="server"  class="dnnFormItem">
                    <dnn:label id="plAnswer" runat="server" controlname="txtAnswer" text="Password Answer:"></dnn:label>
			...
			<asp:panel id="pnlQA" runat="server">
                ...
                <div class="dnnFormItem">
                    <dnn:label id="plEditQuestion" runat="server" controlname="lblQuetxtEditQuestionstion" text="Password Question:"></dnn:label>
                    <asp:textbox id="txtEditQuestion" runat="server" cssclass="NormalTextBox" size="25" maxlength="20"></asp:textbox>
                </div>
                <div class="dnnFormItem">
                    <dnn:label id="plEditAnswer" runat="server" controlname="txtEditAnswer" text="Password Answer:"></dnn:label>
                    <asp:textbox id="txtEditAnswer" runat="server" cssclass="NormalTextBox" size="25" maxlength="20"></asp:textbox>
                </div>
                <ul class="dnnActions dnnClear">
                    <li><asp:LinkButton id="cmdUpdateQA" runat="server" CssClass="dnnPrimaryAction" resourcekey="SaveQA" /></li>
                </ul>  
			</asp:panel>
    </fieldset>
</div>
