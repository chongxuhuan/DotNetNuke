    ...
    <tr>
        <td width="100%" valign="top">
            <asp:Panel ID="pnlRoles" runat="server" Visible="True">
                <table cellspacing="0" cellpadding="0" border="0" class="dnnForm dnnSecurityRoles dnnClear">
                ...
                <asp:CompareValidator ID="valEffectiveDate" CssClass="NormalRed" runat="server" resourcekey="valEffectiveDate" Display="Dynamic" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtEffectiveDate" />
                <asp:CompareValidator ID="valExpiryDate" CssClass="NormalRed" runat="server" resourcekey="valExpiryDate" Display="Dynamic" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtExpiryDate" />
                <asp:CompareValidator ID="valDates" CssClass="NormalRed" runat="server" resourcekey="valDates" Display="Dynamic" Type="Date" Operator="GreaterThan" ControlToValidate="txtExpiryDate" ControlToCompare="txtEffectiveDate" />
            </asp:Panel>
