...
<div class="dnnForm dnnPageSettings dnnClear" id="tabSettingsForm">
       ...
       <div class="psdContent dnnClear">
           ...
           <fieldset>
                ...
                <div id="insertPositionRow" class="dnnFormItem" runat="server">
                    ...
                    <asp:RadioButtonList ID="rbInsertPosition" runat="server" CssClass="dnnSSRadioButtons" RepeatDirection="Horizontal" AutoPostBack="true" />
                ...
                <div id="copyPanel" runat="server">
                    ...
                    <div id="modulesRow" runat="server" class="dnnFormItem">
                        ...
                        <asp:DataGrid ID="grdModules" runat="server" DataKeyField="ModuleID" ShowHeader="False" ItemStyle-CssClass="Normal" GridLines="None" BorderWidth="0px" BorderStyle="None" AutoGenerateColumns="False" CellSpacing="0" CellPadding="0" Width="100%">
                            <Columns>
                                <asp:TemplateColumn>
                                ...
                                <asp:TemplateColumn>
                                    <ItemTemplate>
                                        <asp:RadioButton ID="optNew" runat="server" CssClass="dnnSSRadioButtons" GroupName="Copy" resourcekey="ModuleNew" Checked="True" />
                                        <asp:RadioButton ID="optCopy" runat="server" CssClass="dnnSSRadioButtons" GroupName="Copy" resourcekey="ModuleCopy" Enabled='<%# DataBinder.Eval(Container.DataItem, "IsPortable") %>' />
                                        <asp:RadioButton ID="optReference" runat="server" CssClass="dnnSSRadioButtons" GroupName="Copy" resourcekey="ModuleReference" Enabled='<%# Convert.ToInt32(DataBinder.Eval(Container.DataItem, "ModuleID")) != -1  %>' />
                                    </ItemTemplate>
                                    <ItemStyle Wrap="False"></ItemStyle>
                                </asp:TemplateColumn>
                            </Columns>
    ...
    <div id="dnnPermissions" class="dnnPermissions dnnClear">
        <div class="pspContent dnnClear">
            <fieldset>
    	        <legend></legend>
                <div id="permissionRow" runat="server">
    ...
    <div id="dnnAdvancedSettings" class="dnnAdvancedSettings dnnClear">
        <div class="psasContent dnnClear">
            <div class="dnnFormItem"><%=LocalizeString("AdvancedSettingsHelp")%></div>
            <h2 id="Panel-Appearance" class="dnnFormSectionHead"><a href="" class="dnnLabelExpanded"><%=LocalizeString("Appearance")%></a></h2>
            <fieldset>
    	        <legend></legend>
                <div class="dnnFormItem">
                ...
                <div class="dnnFormItem">
                    ...
                    <dnn:URL ID="ctlIconLarge" runat="server" ShowLog="False" />
                </div>       
                <div class="dnnFormItem">
                ...
                <div class="dnnFormItem">
                    ...
                    <a href="javascript:void(0);" class="dnnSecondaryAction" onclick="return dnn_PreviewSkin('pageSkinCombo', 'pageContainerCombo')"><%=LocalizeString("SkinPreview")%></a>
                </div>
            ...
            <h2 id="Panel-CacheSettings"  class="dnnFormSectionHead"><a href="" class=""><%=LocalizeString("CacheSettings")%></a></h2>
            <fieldset>
    	        <legend></legend>
                <div class="dnnFormItem">
            ...
            <h2 id="Panel-OtherSettings" class="dnnFormSectionHead"><a href="" class=""><%=LocalizeString("OtherSettings")%></a></h2>
            <fieldset>
    	        <legend></legend>
                <div class="dnnFormItem">
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:TextBox ID="txtStartDate" runat="server" MaxLength="11" Width="120" Columns="30" />&nbsp;
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:TextBox ID="txtEndDate" runat="server" MaxLength="11" Width="120" Columns="30" />&nbsp;
