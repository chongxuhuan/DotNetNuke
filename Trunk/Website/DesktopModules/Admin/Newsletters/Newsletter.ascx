            ...
            <fieldset>
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:RegularExpressionValidator ID="revReplyTo" runat="server" resourcekey="revEmailAddress.ErrorMessage"
                        CssClass="dnnFormMessage dnnFormError" ControlToValidate="txtReplyTo"
                        ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" />
                </div>
                <div class="dnnFormItem">
            ...
            <fieldset>
                ...
                <div id="pnlRelayAddress" runat="server" visible="false" class="dnnFormItem">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" resourcekey="revEmailAddress.ErrorMessage"
                        CssClass="dnnFormMessage dnnFormError" ControlToValidate="txtRelayAddress"
                        ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" />
                </div>
                <div class="dnnFormItem">
                    <dnn:Label id="plSendAction" runat="server" ControlName="optSendAction" />
                    <asp:RadioButtonList id="optSendAction" runat="server" RepeatDirection="Horizontal">
