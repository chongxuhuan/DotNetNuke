    ...
    <table cellspacing="0" cellpadding="3" border="0" summary="SignIn Design Table" width="160">
	    ...
	    <tr>
		    <td id="tdRegister" runat="server" colspan="2" align="left">
                <asp:HyperLink ID="registerLink" runat="server" CssClass="CommandButton" resourcekey="cmdRegister"/>
            </td>
	    </tr>
	    <tr>
		    <td id="tdPassword" runat="server" colspan="2" align="left">
                <asp:HyperLink ID="passwordLink" runat="server" CssClass="CommandButton" resourcekey="cmdPassword"/>
            </td>
	    </tr>
	    <tr>
