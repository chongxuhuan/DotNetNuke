...
<div class="dnnForm dnnHostSettings dnnClear" id="dnnHostSettings">
    ...
    <fieldset>
        <div class="dnnFormItem">
            ...
            <dnn:DnnComboBox ID="ddlLogs" runat="server" AutoPostBack="true"  />        
        </div>
        <div class="dnnFormItem">
            <asp:TextBox ID="txtLogContents" runat="server" TextMode="MultiLine" Rows="20" Columns="75" EnableViewState="True" Enabled="false" Visible="False" />
        </div>
