        ...
        <div class="ssbsContent dnnClear">
            ...
            <fieldset>
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:RadioButtonList ID="optBanners" CssClass="dnnSSRadioButtons" runat="server" EnableViewState="False" RepeatLayout="Flow">
        ...
        <div class="ssasContent">
            ...
            <fieldset class="ssasUsabilitySettings">
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:radiobuttonlist id="optControlPanelMode" runat="server" RepeatLayout="Flow" CssClass="dnnSSRadioButtons">
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:radiobuttonlist id="optControlPanelVisibility" runat="server" RepeatLayout="Flow" CssClass="dnnSSRadioButtons">
                ...
                <div class="dnnFormItem">
                    ...
                    <asp:radiobuttonlist id="optControlPanelSecurity" runat="server" RepeatLayout="Flow" CssClass="dnnSSRadioButtons">
            ...
            <div id="hostSections" runat="server">
                ...
                <fieldset>
                    ...
                    <div class="dnnFormItem">
                        ...
                        <asp:CompareValidator ID="valHostFee" runat="server" ControlToValidate="txtHostFee" CssClass="dnnFormError" Display="Dynamic" ResourceKey="valHostFee.Error" Operator="DataTypeCheck" Type="Currency" />
                    </div>
                    <div class="dnnFormItem">
