...
<dnn:sectionhead ID="dshConfigEditor" runat="server" CssClass="Head" 
    Text="Configuration" Section="tblConfiguration" ResourceKey="Configuration" />
<table id="tblConfiguration" runat="server" width="100%" cellpadding="2" cellspacing="2" summary="Edit Configuration Files Table" border="0">
    <tr>
        ...
        <td valign="middle">
            <dnn:DnnComboBox ID="ddlConfig" runat="server"/>    
            <asp:LinkButton ID="cmdLoad" resourcekey="cmdLoad" EnableViewState="False" CssClass="CommandButton"
                runat="server" ToolTip="Load the selected configuration file.">Load</asp:LinkButton>
        </td>    
    </tr>
    <tr>
        <td colspan="2">
            <asp:TextBox ID="txtConfiguration" runat="server" TextMode="MultiLine" width="100%" Rows="20"
            EnableViewState="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            <asp:LinkButton ID="cmdSave" resourcekey="cmdSave" EnableViewState="False"
            CssClass="CommandButton" runat="server" >Save</asp:LinkButton>
        </td>
    </tr>
</table>
<hr style="margin: 10px 0"/>
<dnn:sectionhead ID="dshScriptMerge" runat="server" CssClass="Head" 
    Text="Configuration" Section="tblScriptMerge" ResourceKey="Merge" IsExpanded="false" />
<table id="tblScriptMerge" runat="server" width="100%" cellspacing="2" cellpadding="2" summary="Load Merge Script Design Table" border="0">
    ...
    <tr>
        <td colspan="2">
            <asp:TextBox ID="txtScript" runat="server" TextMode="MultiLine" width="100%" Rows="20"
            EnableViewState="False"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td colspan="2">
            ...
            CssClass="CommandButton" runat="server" >Execute</asp:LinkButton>
        </td>
    </tr>
</table>
