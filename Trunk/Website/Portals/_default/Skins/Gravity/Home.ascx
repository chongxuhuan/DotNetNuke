...
<dnn:DnnJsInclude runat="server" FilePath="~/Portals/_default/skins/gravity/Scripts/slides.min.jquery.js" />
<script>
	$(function(){
		$('#slides').slides({
			preload: true,
    ...
    <div id="contentWrapper" class="wrapper">
        <div id="content">
            ...
            <div>
				...
				<div id="sidebarPane" class="sidebarPane spacingTop spacingLeft" runat="server"></div>
				<div class="clear"></div>
			</div>
