...
<table id="tblMaster" cellspacing="2" cellpadding="2" summary="Master Design Table" border="0" runat="server" visible="false" width="750px">
	<tr>
...
<table id="tblEdit" cellspacing="2" cellpadding="2" summary="Review Design Table" border="0" runat="server"  width="750px">
	<tr valign="bottom">
		<td>
