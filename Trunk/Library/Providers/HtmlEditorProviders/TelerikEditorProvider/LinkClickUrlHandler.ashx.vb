            ...
            If (params IsNot Nothing) Then
                ...
                Select Case params.LinkAction
                    Case "GetLoggingInfo" 'also meant for the tracking tab but this is to retrieve the user information
                        ...
                        Dim logText As String = "<table><tr><th>Date</th><th>User</th></tr><tr><td colspan='2'>The selected date-range did<br /> not return any results.</td></tr>"

                        If DateTime.TryParse(params.LogStartDate, logStartDate) Then
                            If Not DateTime.TryParse(params.LogEndDate, logEndDate) Then
